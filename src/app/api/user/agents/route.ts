...
// GET /api/user/agents — list all user-level agent files
export async function GET() {
  const files = listDirectoryFiles(agentsDir(), EXTENSION);
  return NextResponse.json(files);
}

// POST /api/user/agents — create a new agent file
...
// PUT /api/user/agents — update an existing agent file
...
// DELETE /api/user/agents?name=xxx — delete an agent file
